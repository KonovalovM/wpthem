...
//          вивід постів
            $posts = get_posts( array(
                'numberposts' => '3', //кількість постів
                'order'       => 'ASC', //сортування записів по даті
//                'category'    => 0, з якої категорії
//                'include'     => array(), добавляє додаткові пости
//                'exclude'     => array(), виключає певні пости
                'post_type'   => 'post', //вивод постів
...
<!--                        <?php the_posts_pagination (); ?> не працюэ коректно-->
